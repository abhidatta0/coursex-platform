...
const useFetchPrevOrNextLessonId = (direction: 'prev'|'next',lessonId?: string, )=>{
    return useQuery({
      queryKey:[direction === 'prev' ? QueryKeys.prevLessonId: QueryKeys.nextLessonId,  lessonId ? lessonId : ''],
